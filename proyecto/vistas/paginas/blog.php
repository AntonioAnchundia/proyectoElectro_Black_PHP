...
<section>
    <div class="fondo-subcription">
        <div>
            <div class="fondo-subcription-1">
                <img style="width: 100%;" src="recursos/imagenes/suscripcion.png" alt="suscripcion">
            </div>
        </div>
        <div>
            <div class="fondo-section">
                <img style="width: 100%;" src="recursos/imagenes/logo-img.jpg" alt="fondo">
                <h1 class="pregunta"> ¿Te gusta el sol? </h1>
            </div>
        </div>
        <div class="noticias">
